...
public class CategoryApiTest extends AbstractApiTest {
  ...
  public void testCreateCategory() throws Exception {
    ...
    MvcResult result = mvc
        .perform(post(new URI(CATEGORIES_URI)).contentType(APPLICATION_JSON)
            .content(writeValueAsString(newCategoryDto)))
  ...
  public void testGetCategory() throws Exception {
    ...
    MvcResult result =
        mvc.perform(get(CATEGORIES_ID_URI, ID)).andExpect(status().isOk()).andReturn();
