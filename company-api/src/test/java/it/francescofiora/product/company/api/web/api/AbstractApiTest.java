...
public abstract class AbstractApiTest {
  ...
  protected ResultActions performPost(String path, Object content)
      throws Exception {
    // @formatter:off
  ...
  protected ResultActions performPost(String path, Long id, Object content)
      throws Exception {
    // @formatter:off
  ...
  protected ResultActions performPut(String path, Object content)
      throws Exception {
    // @formatter:off
  ...
  protected ResultActions performPut(String path, Long id, Object content)
      throws Exception {
    // @formatter:off
  ...
  protected ResultActions performGet(String path, Pageable pageable)
      throws Exception {
    // @formatter:off
  ...
  protected ResultActions performGet(String path, Long id, Pageable pageable)
      throws Exception {
    // @formatter:off
